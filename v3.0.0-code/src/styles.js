...
// añade T (tokens), nuevas helper styles para v3 (cardV3, hero, widget…).
// ─────────────────────────────────────────────────────────────────────────────
...
// who → color hex (consistent with DEFAULT_COLORS but as a helper for chrome)
...
// Mission card with optional left rail by who-color
...
// Editorial Week hero (used in Semana view)
...
// Generic widget card (Home dashboard)
export const widget = {
  background: "#1d1733",
...
// Pill button used as filter chip / tab
...
// Eyebrow micro-label (10px uppercase tracking-2)

// OverflowMenu.jsx — v3.0.0
// Popover ⋯ que reemplaza los botones grandes del header (Actualizar versión,
// .ics, PDF, compartir). Acepta items como children o como prop `items`.
//
// Uso:
//   const [open, setOpen] = useState(false);
//   <button onClick={()=>setOpen(o=>!o)}>⋯</button>
//   <OverflowMenu open={open} onClose={()=>setOpen(false)} items={[
//     { icon:"↻", label:"Actualizar versión", onClick: doUpdate },
//     { divider: true },
//     { icon:"📅", label:"Exportar a Google Calendar (.ics)", onClick: doIcs },
//     { icon:"🖨", label:"Imprimir / PDF", onClick: doPdf },
//     { icon:"📎", label:"Compartir resumen", onClick: doShare },
//   ]} />
...
// Botón ⋯ helper — úsalo en topbar/headers.

// MissionCard.jsx — v3.0.0
// Cambios respecto a v2.5:
//   • Riel izquierdo de 3px del color de la persona (pink P1, purple P2, green Juntos)
//   • Pop animation del emoji de status al ciclar (bounce 0.22s)
//   • Resto de la API SIN CAMBIOS — props, expandido, dnd, edición, todo idéntico
...
export default function MissionCard({ mission, onCycleStatus, onDelete, onPatch, p1, p2, colors, goals, weeksData }) {
  ...
  // v3.0.0 — Riel de color de persona
  const railStyle = {
    borderLeft: `3px solid ${whoColor}`,
    paddingLeft: 13, // 16 (S.card) - 3
  };
...
// IMPORTANTE: añade estos keyframes al CSS global (ej. index.css):
//
// @keyframes mc-pop {
//   0%   { transform: scale(1); }

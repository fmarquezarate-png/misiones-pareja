// ─────────────────────────────────────────────────────────────────────────────
// Toast.jsx — v3.0.0
// Toasts contextuales con tres variantes: loading, success, error (con retry).
// API:
//   const { toast, push, dismiss } = useToast();
//   push({ kind:"success", text:"✓ ¡App actualizada!" });
//   push({ kind:"loading", text:"Actualizando…" });
//   push({ kind:"error", text:"⚠ No se pudo", onRetry: handleRetry });
//
// Auto-dismiss en success (2.5s). Loading/error se quedan hasta que llames
// dismiss() o push() otra cosa.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function Toast({ toast, onRetry, onDismiss }) {

// CalendarView.jsx — v3.0.0
// Cambios respecto a v2.5:
//   • Hoy se marca con anillo pink (no fill bg) — distingue de "seleccionado"
//   • Mini barra de densidad por persona en el footer de cada celda
//   • Los botones .ics y PDF se MUEVEN al menú ⋯ en App.jsx (ya no aparecen aquí)
//   • Resto de la API SIN CAMBIOS — DnD, edición inline, panel de día, todo idéntico
//
// Las props onDownloadICS y onDownloadPDF siguen aceptándose para retro-compat
// pero ya no se renderizan los botones — App.jsx los expone via OverflowMenu.
...
export default function CalendarView({
  ...
  return (
    <div>
      {/* v3.0.0: botones .ics/PDF removidos → ahora en menú ⋯ del header (App.jsx) */}
      <div>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(7,1fr)", gap:3 }}>
          {cells.map((day, i) => {
            ...
            // v3.0.0: hoy se marca con ANILLO en el número, no con bg de la celda
            ...
            // Counts por persona para barra de densidad
            ...
            return (
              <div key={day} onClick={()=>setSelectedDay(isSel ? null : day)}
                ...
                {/* Número del día — con anillo si es hoy */}
                ...
                {/* v3.0.0: Barra de densidad por persona */}
                {ms.length > 0 && (
                  <div style={{
        ...
        {/* Day detail panel — sin cambios respecto a v2.5 */}
        {selectedDay && (

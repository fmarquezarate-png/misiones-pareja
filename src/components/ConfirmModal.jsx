...
export function useConfirm() {
  ...
  const confirm = useCallback((msg, onYes, { danger = true } = {}) => {
    setState({ msg, onYes, danger });
  }, []);
  ...
  const ConfirmDialog = () => state ? (
    <>
      ...
      <div role="alertdialog" aria-modal="true" aria-labelledby="confirm-msg"
        ...
        <p id="confirm-msg" style={{ margin:"0 0 20px", fontSize:14, lineHeight:1.55, color:"var(--t-text,#f8f4ff)", textAlign:"center" }}>
          {state.msg}
        </p>

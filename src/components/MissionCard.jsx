      ...
      <div style={{ display:"flex", gap:10, alignItems:"center" }}>
        ...
        <div style={{ flex:1, minWidth:0, cursor:"pointer" }} onClick={()=>setExpanded(v=>!v)}>
          ...
          <div style={{ display:"flex", gap:4, marginTop:4, flexWrap:"wrap" }}>
            ...
            {mission.who==="together"&&<span style={{ background:`${clr.together}18`, color:`var(--t-together-ink,${clr.together})`, border:`1px solid ${clr.together}40`, padding:"2px 7px", borderRadius:99, fontSize:11, fontWeight:600 }}>👫 Juntos</span>}
            {mission.who==="person1"&&<span style={{ background:`${clr.person1}18`, color:`var(--t-p1-ink,${clr.person1})`, border:`1px solid ${clr.person1}40`, padding:"2px 7px", borderRadius:99, fontSize:11, fontWeight:600 }}>🙋 {p1}</span>}
            {mission.who==="person2"&&<span style={{ background:`${clr.person2}18`, color:`var(--t-p2-ink,${clr.person2})`, border:`1px solid ${clr.person2}40`, padding:"2px 7px", borderRadius:99, fontSize:11, fontWeight:600 }}>🙋 {p2}</span>}

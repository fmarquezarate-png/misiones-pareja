...
export default function OnboardingScreen({ session, onDone }) {
  ...
  const backBtn = { background:"none", border:"none", color:"var(--t-text-dim,#8f84ad)", cursor:"pointer", fontSize:13, fontFamily:"inherit", marginBottom:20, padding:0 };
    ...
    <div style={{ background:"#0a0714", minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"'Plus Jakarta Sans','Segoe UI',system-ui,sans-serif", color:"#f8f4ff", padding:20 }}>
      ...
      <div style={{ maxWidth:360, width:"100%" }}>
        <div style={{ textAlign:"center", marginBottom:32 }}>
          ...
          <div style={{ fontSize:13, color:"var(--t-text-muted,#b9b0d0)", marginTop:8 }}>
        ...
        {step === "choice" && (
          <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
            ...
            <div style={{ background:"rgba(167,139,250,0.08)", border:"1px solid rgba(167,139,250,0.18)", borderRadius:14, padding:"14px 16px", marginBottom:6 }}>
              ...
              <div style={{ display:"flex", justifyContent:"center", gap:12, marginTop:12, fontSize:11, color:"var(--t-text-muted,#b9b0d0)", flexWrap:"wrap" }}>
                <span>🗓️ Planificáis juntos</span>
                <span>🤝 Repartís tareas</span>
                <span>💬 Todo en un sitio</span>
              </div>
            </div>
            <div style={{ fontSize:13, color:"var(--t-text-muted,#b9b0d0)", textAlign:"center", marginBottom:8 }}>¿Qué quieres hacer?</div>
        ...
        {step === "create" && (
          <div>
            ...
            <div style={{ fontSize:14, color:"var(--t-text-muted,#b9b0d0)", marginBottom:20 }}>
              Crea un espacio privado para vuestra pareja con un código único que compartiréis.
            </div>
            <div style={{ marginBottom:12 }}>
              <div style={{ fontSize:11, letterSpacing:2, textTransform:"uppercase", color:"var(--t-text-dim,#8f84ad)", fontWeight:600, marginBottom:6 }}>Tu nombre</div>
              <input value={name} onChange={e=>setName(e.target.value)} placeholder="Ej: Ana, Carlos…" style={inputStyle} />
            </div>
            <div style={{ marginBottom:20 }}>
              <div style={{ fontSize:11, letterSpacing:2, textTransform:"uppercase", color:"var(--t-text-dim,#8f84ad)", fontWeight:600, marginBottom:6 }}>Código de pareja</div>
              ...
              <div style={{ fontSize:11, color:"var(--t-text-dim,#8f84ad)", marginTop:5 }}>Este código lo usará tu pareja para unirse. Elige algo memorable.</div>
            </div>

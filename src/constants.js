...
export const CHANGELOG = [
  { v:"3.3.5", date:"2026-05-13", notes:["Fix crítico: saveData upsert ya no envía updated_at — enviarlo causaba error 400 (PostgREST) y bloqueaba todos los guardados, perdiendo datos","Sync ⬆ Subir: verifica el guardado leyendo de vuelta los datos reales de Supabase y mostrando el conteo de semanas — confirmación real sin depender de updated_at","Versión 3.3.5"] },

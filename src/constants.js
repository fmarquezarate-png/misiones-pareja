...
export const CHANGELOG = [
  { v:"3.3.5", date:"2026-05-13", notes:["Fix crítico: eliminada columna 'updated_at' del upsert y de loadData — esa columna no existe en la tabla app_data, causaba error 400 (PostgREST 42703) en cada guardado y en la carga","Fix: forcePush verifica la existencia del registro en Supabase tras guardar (sin depender de updated_at)","Versión 3.3.5"] },

...
export const CHANGELOG = [
  { v:"3.3.6", date:"2026-05-14", notes:["Fix race condition: al recibir actualización del partner vía Realtime se cancela el debounce pendiente — ya no sobreescribe los cambios del partner con estado local viejo","Fix iOS: handler visibilitychange fuerza el save inmediatamente al pasar la app a background — evita perder cambios cuando iOS cierra antes de los 700ms del debounce","Fix falso save: la carga inicial solo guarda a Supabase si hubo migración de schema (didMigrate), no en cada sesión — elimina backups espurios","Sync ⬆ Subir: verificación por timestamp real (updated_at) restaurada — ahora funciona correctamente gracias al trigger BEFORE UPDATE en Supabase","Versión 3.3.6"] },

...
export const CHANGELOG = [
  { v:"3.3.5", date:"2026-05-13", notes:["Fix: saveData upsert envía updated_at explícitamente y lo lee de vuelta — garantiza que el timestamp se actualiza en cada guardado","Sync ⬆ Subir: verifica timestamp real de Supabase — muestra '✅ Guardado · HH:MM:SS (hace Xs)'; alerta si updated_at tiene más de 30s de diferencia","Versión 3.3.5"] },

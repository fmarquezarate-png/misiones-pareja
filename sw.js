...
class I {
  ...
  handleAll(e) {
    ...
    const t = e.event, n = typeof e.request == "string" ? new Request(e.request) : e.request, a = "params" in e ? e.params : void 0, r = new ce(this, { event: t, request: n, params: a }), i = this._getResponse(r, n, t), c = this._awaitComplete(i, r, n, t);
    return [i, c];
  }
...
let w;
const ue = () => (w || (w = new le(), w.addFetchListener(), w.addCacheListener()), w);
function N(s, e, t) {
  let n;
  if (typeof s == "string") {
...
const me = "-precache-", we = async (s, e = me) => {
...
const $ = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap();
function Le(s) {
...
function Pe(s) {
  return typeof s == "function" ? ke(s) : (s instanceof IDBTransaction && Te(s), xe(s, Ee()) ? new Proxy(s, P) : s);
}
function f(s) {
...
const T = (s) => M.get(s);
function Ie(s, e, { blocked: t, upgrade: n, blocking: a, terminated: r } = {}) {
...
const Me = ["get", "getKey", "getAll", "getAllKeys", "count"], ve = ["put", "add", "delete", "clear"], U = /* @__PURE__ */ new Map();
function W(s, e) {
  if (!(s instanceof IDBDatabase && !(e in s) && typeof e == "string"))
    return;
  if (U.get(e))
    return U.get(e);
  const t = e.replace(/FromIndex$/, ""), n = e !== t, a = ve.includes(t);
  if (
    // Bail if the target doesn't exist on the target. Eg, getAll isn't in Edge.
    !(t in (n ? IDBIndex : IDBObjectStore).prototype) || !(a || Me.includes(t))
  )
    return;
...
const Ke = "workbox-expiration", y = "cache-entries", j = (s) => {
...
class Se {
   ...
   */
  async getDb() {
    return this._db || (this._db = await Ie(Ke, 1, {
...
Re([{"revision":"0ea6b54380eec2e9841542013e270ee0","url":"registerSW.js"},{"revision":"0acb52cbdb1788eeaaae01d53ff94936","url":"index.html"},{"revision":null,"url":"assets/index-COsQ2zRQ.js"},{"revision":"d1549e1ed2a80ed70ce979324ccbf36f","url":"icon-192.png"},{"revision":"1031ffc7c2c6d1cd4292c7260da162c3","url":"icon-512.png"},{"revision":"f1e49fccca550436cdbcf0e69c825f2f","url":"icon-maskable-192.png"},{"revision":"7b74422b49ca568b00ca9b999d5e3a4d","url":"icon-maskable-512.png"},{"revision":"7385c6a48bfaa095330b8dc3b0d49c0a","url":"manifest.webmanifest"}]);
ye();
...
self.addEventListener("message", (s) => {
  var e;
  ((e = s.data) == null ? void 0 : e.type) === "SKIP_WAITING" && self.skipWaiting();
});
self.addEventListener("activate", (s) => {
  s.waitUntil(clients.claim());
});
N(
  ({ url: s }) => s.pathname === "/version.json",
  new Ce()
);
N(
  ...
  new be({
    ...
    plugins: [new We({ maxEntries: 10, maxAgeSeconds: 60 * 60 * 24 * 365 })]
  })
);
self.addEventListener("push", (s) => {
  ...
  const {
    title: t = "Misiones de Pareja",
    body: n = "Tu pareja hizo cambios en la app",
    tag: a = "mp-push",
    url: r = "/"
  } = e, i = typeof t == "string" ? t.slice(0, 100) : "Misiones de Pareja", c = typeof n == "string" ? n.slice(0, 300) : "Tu pareja hizo cambios en la app";
  s.waitUntil(
    self.registration.showNotification(i, {
      body: c,
      tag: a,
      icon: "/icon-192.png",
      badge: "/icon-192.png",
...
self.addEventListener("notificationclick", (s) => {
  ...
  const e = ((n = s.notification.data) == null ? void 0 : n.url) || "/", t = e.startsWith("/") || e.startsWith(self.location.origin) ? e : "/";
  s.waitUntil(
    clients.matchAll({ type: "window", includeUncontrolled: !0 }).then((a) => {
      for (const r of a)
        if (r.url.startsWith(self.location.origin) && "focus" in r) return r.focus();
